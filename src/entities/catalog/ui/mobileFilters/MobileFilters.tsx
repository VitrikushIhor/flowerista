...
import {userShared} from '../../../shared/model/selectors/getShared.ts';
...
export const MobileFilters: FC<IFilters> = (props) => {
	...
	const {data: flowers} = useGetFlowers(currentLanguage);
	const {data: colors} = useGetColors(currentLanguage);
